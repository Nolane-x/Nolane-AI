...
- AI ID: `security.threat-model.01`
...
- Private: `security.threat-model.01-delta-0.1`
- Resolved composition: `NUC-0.1+REGION-security-adversarial-0.1+security.threat-model.01-delta-0.1`
- Accepted runtime neural version: `NUC-0.1+security.threat-model.01-delta-0.1`
...
- Private version: `security.threat-model.01-EXT-0.0.0`
...
- Memory: `agent/security.threat-model.01`
- Skills: `skills/personal/security.threat-model.01`
