...
- AI ID: `security.supply-chain.01`
- Role: dependency and supply-chain security
- Rank: `specialist`
...
- Private: `security.supply-chain.01-delta-0.1`
- Resolved composition: `NUC-0.1+REGION-security-adversarial-0.1+security.supply-chain.01-delta-0.1`
- Accepted runtime neural version: `NUC-0.1+security.supply-chain.01-delta-0.1`
...
- Private version: `security.supply-chain.01-EXT-0.0.0`
...
- Memory: `agent/security.supply-chain.01`
- Skills: `skills/personal/security.supply-chain.01`
