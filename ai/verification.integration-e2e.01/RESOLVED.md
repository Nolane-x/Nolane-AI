...
- AI ID: `verification.integration-e2e.01`
- Role: integration and end-to-end verification
...
- Private: `verification.integration-e2e.01-delta-0.1`
- Resolved composition: `NUC-0.1+REGION-verification-testing-0.1+verification.integration-e2e.01-delta-0.1`
- Accepted runtime neural version: `NUC-0.1+verification.integration-e2e.01-delta-0.1`
...
- Private version: `verification.integration-e2e.01-EXT-0.0.0`
...
- Memory: `agent/verification.integration-e2e.01`
- Skills: `skills/personal/verification.integration-e2e.01`
