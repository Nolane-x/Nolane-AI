# Runtime Trace Investigator

- AI ID: `debug.runtime-trace.01`
- Role: runtime tracing and state diagnosis
...
- Private: `debug.runtime-trace.01-delta-0.1`
- Resolved composition: `NUC-0.1+REGION-debugging-failure-0.1+debug.runtime-trace.01-delta-0.1`
- Accepted runtime neural version: `NUC-0.1+debug.runtime-trace.01-delta-0.1`
...
- Private version: `debug.runtime-trace.01-EXT-0.0.0`
...
- Memory: `agent/debug.runtime-trace.01`
- Skills: `skills/personal/debug.runtime-trace.01`
