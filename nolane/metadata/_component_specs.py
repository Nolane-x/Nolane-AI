...
COMPONENT_SPECS: tuple[tuple[str, str, str, str, tuple[str, ...]], ...] = (
    ...
    ("external.reasoning_invention", "external_core", "stateless evidence-bound invention hypotheses, independent challenge, Pareto frontier and downstream intent envelopes", "reasoning-invention-v1", ("external.cognitive_library", "external.candidate_synthesis", "external.causal", "external.experimentation", "external.evidence")),
