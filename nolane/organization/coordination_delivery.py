...
COMPONENT_ID = "organization.coordination.delivery"
COMPONENT_VERSION = "0.0.1"
MIGRATED_FROM = "cogcoder.organization.coordination_delivery"
...
class DeliveryCoordinator:
    """Canonical causal delivery and acknowledgement authority."""
    ...
    def deliver(self, event_id: str, recipient_agent_id: str) -> DeliveryReceipt:
        ...
        temp = DeliveryReceipt(
            ...
            delivered_at_logical=event.created_at_logical,
    ...
    def to_state(self) -> dict[str, Any]:
        return {"receipts": [row.to_state() for row in self.receipts()], "counter": self._counter}
