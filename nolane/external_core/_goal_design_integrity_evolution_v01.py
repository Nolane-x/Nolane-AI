"""Frozen v0.1 deterministic authority for Goal/Design integrity-contract evolution.

This module preserves the accepted v0.1 receipt identity and transition semantics
for compatibility and truthful historical replay. New authority authenticity is
layered in the public module rather than rewriting this frozen protocol.
"""
