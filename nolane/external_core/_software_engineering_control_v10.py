...
class SoftwareEngineeringControlPlane(_SoftwareEngineeringControlPlaneV09):
    """Frozen F v1.0 public control boundary.

    This file preserves the exact public terminal-lineage semantics that shipped
    with F v1.0. Newer public control layers extend this class monotonically
    rather than changing the meaning or digest shape of already-issued v0.9
    control snapshots and property-bound terminal receipts.
    """
