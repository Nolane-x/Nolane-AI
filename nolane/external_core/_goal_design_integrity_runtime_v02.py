"""Frozen Goal/Design integrity runtime v0.2 with explicit evolution receipts.

This compatibility module preserves the accepted v0.2 state/receipt semantics.
The public runtime layers verifier-backed authority authenticity above it.
"""
...
from ._goal_design_integrity_evolution_v01 import (
