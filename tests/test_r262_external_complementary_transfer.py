from research.r262_external_complementary_transfer import run_external_transfer
...
def test_r262_external_harness_discovers_two_complementary_experiments_without_selected_pair():
