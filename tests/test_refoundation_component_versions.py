...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.context")) == "0.0.4"
    assert str(next_component_version("external.context")) == "0.0.5"
    ...
    assert str(component_version("external.integration")) == "0.0.12"
    assert str(next_component_version("external.integration")) == "0.0.13"
    ...
    assert str(next_component_version("external.execution.control")) == "0.0.20"
