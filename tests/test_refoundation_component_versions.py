...
ACCEPTED_COMPONENT_REVISIONS = {
    ...
    "external.execution.executor": 10,
    "external.execution.control": 27,
...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.integration")) == "0.0.24"
    assert str(next_component_version("external.integration")) == "0.0.25"
    ...
    assert str(component_version("external.execution.executor")) == "0.0.10"
    assert str(next_component_version("external.execution.executor")) == "0.0.11"
    assert str(component_version("external.execution.control")) == "0.0.27"
    assert str(next_component_version("external.execution.control")) == "0.0.28"
    ...
    assert str(component_version("neural.inference_bridge")) == "0.0.9"
    assert str(next_component_version("neural.inference_bridge")) == "0.0.10"
