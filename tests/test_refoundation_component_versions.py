...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(next_component_version("external.integration")) == "0.0.24"
    ...
    assert str(component_version("evaluation.evidence")) == "0.0.3"
    assert str(next_component_version("evaluation.evidence")) == "0.0.4"
    ...
    assert str(component_version("evaluation.campaign")) == "0.0.3"
    assert str(next_component_version("evaluation.campaign")) == "0.0.4"
