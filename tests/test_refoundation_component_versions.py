...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.integration")) == "0.0.18"
    assert str(next_component_version("external.integration")) == "0.0.19"
    ...
    assert str(component_version("external.execution.control")) == "0.0.20"
    assert str(next_component_version("external.execution.control")) == "0.0.21"
