...
ACCEPTED_COMPONENT_REVISIONS = {
    ...
    "external.integration": 19,
    "external.context": 5,
    "external.invokable_cores": 3,
    "external.execution.workspace": 5,
    "external.execution.executor": 5,
    "external.execution.control": 21,
...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.integration")) == "0.0.19"
    assert str(next_component_version("external.integration")) == "0.0.20"
    ...
    assert str(component_version("external.execution.executor")) == "0.0.5"
    assert str(next_component_version("external.execution.executor")) == "0.0.6"
    assert str(component_version("external.execution.control")) == "0.0.21"
    assert str(next_component_version("external.execution.control")) == "0.0.22"
    ...
    assert str(component_version("neural.inference_bridge")) == "0.0.4"
    assert str(next_component_version("neural.inference_bridge")) == "0.0.5"
