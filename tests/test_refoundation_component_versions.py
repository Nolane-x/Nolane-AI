...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.execution.control")) == "0.0.14"
    assert str(next_component_version("external.execution.control")) == "0.0.15"
