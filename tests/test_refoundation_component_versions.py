...
ACCEPTED_COMPONENT_REVISIONS = {
    ...
    "external.integration": 20,
    "external.context": 5,
    "external.invokable_cores": 3,
    "external.execution.workspace": 5,
    "external.execution.executor": 6,
    "external.execution.control": 22,
...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.integration")) == "0.0.20"
    assert str(next_component_version("external.integration")) == "0.0.21"
    ...
    assert str(component_version("external.execution.executor")) == "0.0.6"
    assert str(next_component_version("external.execution.executor")) == "0.0.7"
    assert str(component_version("external.execution.control")) == "0.0.22"
    assert str(next_component_version("external.execution.control")) == "0.0.23"
    ...
    assert str(component_version("neural.inference_bridge")) == "0.0.5"
    assert str(next_component_version("neural.inference_bridge")) == "0.0.6"
