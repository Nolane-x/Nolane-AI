...
ACCEPTED_COMPONENT_REVISIONS = {
    ...
    "external.execution.executor": 12,
    "external.execution.control": 29,
...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(component_version("external.integration")) == "0.0.26"
    assert str(next_component_version("external.integration")) == "0.0.27"
    ...
    assert str(component_version("external.execution.executor")) == "0.0.12"
    assert str(next_component_version("external.execution.executor")) == "0.0.13"
    assert str(component_version("external.execution.control")) == "0.0.29"
    assert str(next_component_version("external.execution.control")) == "0.0.30"
    ...
    assert str(component_version("neural.inference_bridge")) == "0.0.11"
    assert str(next_component_version("neural.inference_bridge")) == "0.0.12"
