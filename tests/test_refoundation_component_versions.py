...
ACCEPTED_COMPONENT_REVISIONS = {
    ...
    "external.integration": 25,
    "external.context": 5,
    "external.invokable_cores": 3,
    "external.execution.workspace": 5,
    "external.execution.executor": 11,
    "external.execution.control": 28,
    "external.coding.claims": 2,
    "external.coding.patches": 2,
    "external.coding.control": 4,
    "external.debugging": 2,
    "external.ui_ux": 2,
...
def test_component_version_lookup_is_local_not_global() -> None:
    ...
    assert str(next_component_version("external.operations")) == "0.0.4"
    assert str(component_version("external.experimentation")) == "0.0.3"
    assert str(next_component_version("external.experimentation")) == "0.0.4"
    ...
    assert str(next_component_version("external.verification")) == "0.0.3"
    assert str(component_version("external.context")) == "0.0.5"
    assert str(next_component_version("external.context")) == "0.0.6"
    assert str(component_version("external.architecture")) == "0.0.6"
    assert str(next_component_version("external.architecture")) == "0.0.7"
    assert str(component_version("external.evidence")) == "0.0.3"
    assert str(next_component_version("external.evidence")) == "0.0.4"
    assert str(component_version("external.integration")) == "0.0.25"
    assert str(next_component_version("external.integration")) == "0.0.26"
    ...
    assert str(component_version("external.execution.executor")) == "0.0.11"
    assert str(next_component_version("external.execution.executor")) == "0.0.12"
    assert str(component_version("external.execution.control")) == "0.0.28"
    assert str(next_component_version("external.execution.control")) == "0.0.29"
    ...
    assert str(component_version("external.coding.control")) == "0.0.4"
    assert str(next_component_version("external.coding.control")) == "0.0.5"
    assert str(component_version("external.debugging")) == "0.0.2"
    assert str(next_component_version("external.debugging")) == "0.0.3"
    assert str(component_version("external.ui_ux")) == "0.0.2"
    assert str(next_component_version("external.ui_ux")) == "0.0.3"
    assert str(component_version("evaluation.regimes")) == "0.0.3"
    assert str(next_component_version("evaluation.regimes")) == "0.0.4"
    assert str(component_version("evaluation.evidence")) == "0.0.4"
    assert str(next_component_version("evaluation.evidence")) == "0.0.5"
    assert str(component_version("evaluation.stress")) == "0.0.3"
    assert str(next_component_version("evaluation.stress")) == "0.0.4"
    assert str(component_version("evaluation.claims")) == "0.0.2"
    assert str(next_component_version("evaluation.claims")) == "0.0.3"
    assert str(component_version("evaluation.parameters")) == "0.0.4"
    assert str(next_component_version("evaluation.parameters")) == "0.0.5"
    assert str(component_version("evaluation.release")) == "0.0.2"
    assert str(next_component_version("evaluation.release")) == "0.0.3"
    ...
    assert str(component_version("neural.inference_bridge")) == "0.0.10"
    assert str(next_component_version("neural.inference_bridge")) == "0.0.11"
