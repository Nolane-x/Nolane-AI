...
def _solve(oracle, fields, discovery_rows, validation_rows, terminal_rows, *, max_basis_size):
    ...
    return r268.synthesize_adaptive_causal_basis(
        ...
        _contexts(fields, discovery_rows), _contexts(fields, validation_rows),
        terminal_contexts=_contexts(fields, terminal_rows), intervention_anchor_values=(0.0,),
        intervention_arity=1, max_basis_size=max_basis_size, composition_constants=(0.0, 2.0),
        ...
        probe_constants=(0.0, 2.0), probe_max_depth=5, probe_max_candidates=50_000, probe_beam_width=192,
    )
...
def test_discovers_one_probe_sufficient_basis_without_false_minimality_claim() -> None:
    ...
    receipt = _solve(oracle, fields,
        ((1,2,3),(2,3,4),(-2,5,7),(4,-3,9),(5,2,11),(-3,-2,13)),
        ((6,7,15),(-5,4,17),(8,-2,19)),
        ((101,103,107),(-109,113,127),(131,-137,139)), max_basis_size=4)
...
def test_certifies_two_probe_sum_basis() -> None:
    ...
    receipt = _solve(oracle, fields,
        ...
        ((2,5),(-3,6),(8,-4)), ((101,103),(-109,113),(127,-131)), max_basis_size=2)
    assert receipt.passed is True
