...
FIELDS=('a','b')
DISCOVERY=(
    {'a':-2.0,'b':-2.0},{'a':-2.0,'b':-1.0},{'a':-1.0,'b':-2.0},
    {'a':1.0,'b':3.0},{'a':4.0,'b':-2.0},{'a':5.0,'b':7.0},
)
VALIDATION=({'a':2.0,'b':5.0},{'a':-3.0,'b':6.0},{'a':8.0,'b':-4.0})
...
def test_discovery_equivalent_aliases_search_each_proposal_class_once(monkeypatch)->None:
    ...
    def run(anchors):
        ...
        receipt=runtime.discover_adaptive_causal_basis(
            _oracle,FIELDS,anchors,DISCOVERY,VALIDATION,intervention_arity=1,max_basis_size=2,
            composition_constants=(0.0,2.0),composition_max_depth=5,
            composition_max_candidates_per_basis=64,max_composition_candidates_total=64,
