...
def test_a6_temporal_contract_survives_a7_current_lane_advance_without_rewriting_a5_admission_artifacts() -> None:
    ...
    assert admission_bundle.ADMISSION_AUDIT_PROTOCOL == "external-integration-admission-audit-v3"
