...
def _rows() -> tuple[dict[str,float], ...]:
    configs=((-3.0,2.0,-7.0,4.0,-5.0),(-1.0,4.0,6.0,-3.0,9.0),(-5.0,1.0,-8.0,5.0,2.0),(0.0,6.0,3.0,-6.0,-4.0),(-4.0,3.0,8.0,2.0,-9.0),(-2.0,5.0,-6.0,-1.0,7.0)); rows=[]
...
def test_nonfinite_intervention_oracle_result_fails_closed_globally() -> None:
    rows=_rows(); calls=0; intervention_failures=0
    ...
    result=discover_contextual_composition_structure(oracle,('x','lo','hi','left','middle','right'),(0.0,),rows[:18],rows[18:24],intervention_arity=1,composition_constants=(0.0,),composition_max_depth=2,composition_max_candidates_per_pair=12000,max_composition_candidates_total=120000)
