from benchmarks.kfigg.r260_active_repository_probe_transfer import run_frozen_heldout


def test_r260_frozen_active_repository_probe_transfer():
    result = run_frozen_heldout()
    summary = result['summary']
    assert result['milestone'] == 'R2.60 Active Diagnostic Repository Probe Synthesis'
