...
COMPONENT_SPECS: tuple[tuple[str, str, str, str, tuple[str, ...]], ...] = (
    ...
    ("evaluation.scaling", "evaluation", "aggregate Part-XV evaluation and future-scaling state", "evaluation-scaling-v1", ("evaluation.regimes", "evaluation.evidence", "evaluation.stress", "evaluation.parameters", "evaluation.release", "evaluation.claims")),
