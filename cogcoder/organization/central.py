...
from .types import AgentStatus, EventKind


# Part II is stacked on the Part-I snapshot schema. Until the shared event
# vocabulary receives its own schema migration, new Central organizational
# actions use named aliases of CENTRAL_INTERVENTION and carry an explicit
# `central_action` subtype in the immutable event payload.
for _name in (
