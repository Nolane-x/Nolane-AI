...
from .campaign_tasks import CampaignTaskRegistry
from .evaluation_regimes import EvaluationMode
    ...
    def __init__(
        ...
        *,
        ...
        if registry is not None and artifacts is not None and evaluation is not None:
            ...
            from .campaign_ingest import CampaignIngestor
            from .campaign_reproduction import CampaignReproductionLedger
