...
from .types import AgentStatus, CognitiveEvent, EventKind
...
class WakeSleepScheduler:
    ...
    @classmethod
    def from_state(cls, *, registry: AgentRegistry, ledger: EventLedger, state: Mapping[str, Any]) -> 'WakeSleepScheduler':
