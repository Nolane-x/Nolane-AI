...
This file is the short operational status index for active research. It exists because the repository README describes older accepted milestones and is not a reliable indicator of the newest experimental branch state.
...
4. active pull-request descriptions/specs;
...
PR #70 (`R2.68-T research — cross-task causal prior transfer`) is a separate complementary research track. It explicitly yields the canonical R2.68 milestone namespace to PR #73 and must not be merged or cited as the R2.68 release.
