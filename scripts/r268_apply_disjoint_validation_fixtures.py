...
if text.count(old)!=1: raise SystemExit(f'external anchor count != 1: {text.count(old)}')
...
old="""VALIDATION = (\n    {'a': 1.0, 'b': 2.0},\n    {'a': 2.0, 'b': 3.0},\n    {'a': 4.0, 'b': 1.0},\n)\n"""
new="""VALIDATION = (\n    {'a': 5.0, 'b': 7.0},\n    {'a': 7.0, 'b': 5.0},\n    {'a': 11.0, 'b': 13.0},\n)\n"""
if text.count(old)!=1: raise SystemExit(f'alias anchor count != 1: {text.count(old)}')
