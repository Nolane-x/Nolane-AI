...
- Canonical module: `none`
- Canonical write authority: `false`
- Legacy/provenance sources: cogcoder/organization/types.py, cogcoder/organization/verification.py
- Notes: Semantic component is active/internal or composition-only, but no dedicated canonical source module is accepted yet.
...
- Component version: `0.0.0`
- Status: `compatibility_facade`
- Canonical module: `nolane.memory.fabric`
- Canonical write authority: `false`
- Legacy/provenance sources: cogcoder/organization/memory.py
- Notes: Public canonical import exists but executable source remains accepted legacy implementation pending cutover receipt.
...
- Component version: `0.0.0`
- Status: `compatibility_facade`
- Canonical module: `nolane.memory.lifecycle`
- Canonical write authority: `false`
- Legacy/provenance sources: cogcoder/organization/memory_lifecycle.py
- Notes: Public canonical import exists but executable source remains accepted legacy implementation pending cutover receipt.
...
- Component version: `0.0.0`
- Status: `compatibility_facade`
- Canonical module: `nolane.memory.retrieval`
- Canonical write authority: `false`
- Legacy/provenance sources: cogcoder/organization/memory_retrieval.py
- Notes: Public canonical import exists but executable source remains accepted legacy implementation pending cutover receipt.
